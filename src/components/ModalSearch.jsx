        ...
        >
          ...
          <div className="py-4 px-2">
            ...
            <div className="mb-3 last:mb-0">
              <div className="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase px-2 mb-2">Recherches recents</div>
              <ul className="text-sm">
                <li>
                  ...
                  >
                    ...
                    <span>Recherches recents 1</span>
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  >
                    ...
                    <span>Recherches recents 2</span>
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  >
                    ...
                    <span>Recherches recents 3</span>
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  >
                    ...
                    <span>Recherches recents 4</span>
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  >
                    ...
                    <span>Recherches recents 5</span>
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  >
                    ...
                    <span>Recherches recents 6</span>
                  </Link>
                </li>
              </ul>
            </div>
